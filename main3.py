...
def get_system_prompt(menu, distritos):
    ...
    **IMPORTANTE: Validación de cantidad solicitada**
    - El cliente puede indicar la cantidad en texto (por ejemplo,"diez","veinticuatro",otras cantidades en texto) o en números (por ejemplo,"10","24",otras cantidade en número).
